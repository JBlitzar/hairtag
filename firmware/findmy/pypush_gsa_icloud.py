...
def generate_anisette_headers():
    try:
        ...
        adi = pyprovision.ADI(
            os.path.dirname(os.path.realpath(__file__)) + "/anisette/"
        )
        adi.provisioning_path = (
            os.path.dirname(os.path.realpath(__file__)) + "/anisette/"
        )
        device = pyprovision.Device(
            os.path.dirname(os.path.realpath(__file__)) + "/anisette/device.json"
        )
